   ...
   // handleFormSubmit = this.handleFormSubmit.bind(this)
    ...
    <div>
        ...
        <Dialog open={this.state.open} onClose={this.onClose}>
            ...
            <DialogActions>
                <Button variant="contained" color="primary" onClick={this.handlerFormSubmit}>추 가</Button>
                <Button variant="outlined" color="primary" onClick={this.handleClose}>닫 기</Button>
            </DialogActions>
        </Dialog>
    </div>
